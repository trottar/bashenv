...
# Description:
# ================================================================
# Time-stamp: "2024-04-11 14:20:54 trottar"
# ================================================================
#
...
def mail():
    ...
    smtp.sendmail(from_addr=os.environ.get('PY_EMAIL_PROF'),
                  to_addrs=[os.environ.get('PY_EMAIL_PROF'), os.environ.get('PY_EMAIL_EVERNOTE')], msg=msg.as_string())
